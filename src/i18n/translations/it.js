...
export const it = {
  ...
  settings: {
    ...
    notePb: 'Performance Battery (opzione batteria standard/piccola)',
    notePbPlus: 'Performance Battery Plus (batteria opzionale/grande)',
  ...
  battery: {
    ...
    tripsPerCharge: 'Viaggi per ricarica',
